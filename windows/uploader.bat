...
set "text=Immich Uploader" & title %text% & set /a width=80, len=0, pad=(width-(for /l %%A in (0,1,1024) do if not "!text:~%%A,1!"=="" set /a len+=1)) / 2 & set "line=" & for /l %%A in (1,1,%pad%) do set "line=!line!-!" & set "line=!line!!text!" & for /l %%A in (1,1,%pad%) do set "line=!line!-!" & echo !line:~0,%width%!
